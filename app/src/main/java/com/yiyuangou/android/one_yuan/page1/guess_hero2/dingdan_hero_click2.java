 ...
 */
public class dingdan_hero_click2 extends Fragment {
    private View view;
    dingdan_hero_adapter adapter ;
    GridView gridView;
    ...
    protected void init_wangluo_init() {
        ...
        String url = all_url.url_jincaidingdan_hero2;
        ...
        asyncHttpClient.post(url,requestParams,new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int arg0, JSONObject arg1) {
				 ...
				 * 适配器和布局在这里初始化好
				 */
                       adapter=new dingdan_hero_adapter(getActivity(), qs_s);
