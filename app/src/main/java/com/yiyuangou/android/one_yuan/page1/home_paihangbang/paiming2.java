 ...
 */
public class paiming2 extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.paiming2, container, false);
        init();
    ...
    private void init_wangluo() {
        AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
        asyncHttpClient.setTimeout(20000);
        String url = all_url.url_caifubang;
        RequestParams requestParams = new RequestParams();
            ...
            public void onSuccess(JSONObject jsonObject) {
                ...
                try {
                    ...
                    if ("true".equals(jsonObject.getString("status"))) {
                        ...
                        paiming2_jd.setText(jsonObject.getString("commissionPoints"));
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            p1.setMoney(jsonArray.getJSONObject(i).getString("commissionPoints"));
