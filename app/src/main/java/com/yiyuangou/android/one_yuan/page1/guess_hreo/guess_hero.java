 ...
 */
public class guess_hero extends Activity {
    ...
    private LinearLayout xiajiemia_last1;
    private LinearLayout xiajiemia_last2;
    private LinearLayout xiajiemia_last3;
                        ...
                        if(jsonObject.getString("bankerStatus").equals("false")){
                            ...
                            shengqingkaicai.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    builder_hero = new AlertDialog.Builder(guess_hero.this);
                                    ...
                                    view.findViewById(R.id.ok_btn).setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
                                            asyncHttpClient.setTimeout(20000);
                                            String url = all_url.url_calcel_kaicai;
                                            RequestParams requestParams = new RequestParams();
                                            requestParams.put("userId", User.getuser().getUser_uuid());
                                            asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
                                                @Override
                                                public void onSuccess(JSONObject jsonObject) {
                                                    ...
                                                    shengqingkaicai.setOnClickListener(new View.OnClickListener() {
                                                        ...
                                                        public void onClick(View v) {
                                                            AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
                                                            asyncHttpClient.setTimeout(20000);
                                                            String url = all_url.url_shenqingliebiao_before;
                                                            RequestParams requestParams = new RequestParams();
                                                            asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
                                                                @Override
                                                                public void onSuccess(JSONObject jsonObject) {
                                                                    ...
                                                                    try {
                                                                        if ("true".equals(jsonObject.getString("status"))) {
                                                                            ...
                                                                            adapter=new ArrayAdapter<String>(guess_hero.this,android.R.layout.simple_spinner_item,m);
                                                                            adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);
                                                                            spinner.setAdapter(adapter);

                                                                            spinner2= (Spinner) view.findViewById(R.id.sqlx);
                                                                            adapter2=new ArrayAdapter<String>(guess_hero.this,android.R.layout.simple_spinner_item,m2);
                                                                            ...
                                                                            ok.setOnClickListener(new View.OnClickListener() {
                                                                                ...
                                                                                public void onClick(View v) {
                                                                                    if(sqjds.getText().toString().isEmpty()){
                                                                                        Toast.makeText(guess_hero.this,"申请金豆数不能为空",Toast.LENGTH_SHORT).show();
                                                                                    }
                                                                                    else{
                                                                                        AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
                                                                                        asyncHttpClient.setTimeout(20000);
                                                                                        String url = all_url.url_shenqingliebiao;
                                                                                        RequestParams requestParams = new RequestParams();
                                                                                        requestParams.put("userId", User.getuser().getUser_uuid());
                                                                                            ...
                                                                                            public void onSuccess(JSONObject jsonObject) {
                                                                                                ...
                                                                                                try {
                                                                                                    if ("true".equals(jsonObject.getString("status"))) {
                                                                                                        ...
                                                                                                        Toast.makeText(guess_hero.this,jsonObject.getString("result"),Toast.LENGTH_SHORT).show();
                                                                                                    } else{
                                                                                                        Toast.makeText(guess_hero.this,jsonObject.getString("result"),Toast.LENGTH_SHORT).show();
                                                                                                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.guess_hero);
        mInflater = LayoutInflater.from(guess_hero.this);
        init();

        if (MainActivity.hero_flag.equals("1")){
            cent_text.setText("英雄竞猜");
        }else{
            cent_text.setText("英雄训练营");
        }
        init_user_info();//用户信息
        wangluo_config();//时间
        init_kaicailiebiao();
        ...
        init_but_animation();
        initSoundPool();//初始化声音
        mygees = new GestureDetector(guess_hero.this, new myGestureListener());
  ...
  //播放下注金币按钮的声音
    ...
    private void init_kaicailiebiao() {
        ...
        kaicailiebiao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                builder_kaicai = new AlertDialog.Builder(guess_hero.this);
                alert_kaicai = builder_kaicai.create();
                AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
                asyncHttpClient.setTimeout(20000);
                String url = all_url.url_kaicailliebiao;
                RequestParams requestParams = new RequestParams();
                requestParams.put("expect", jincai_qs_next.getText().toString());
                asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
                    @Override
                    public void onSuccess(JSONObject jsonObject) {
                        ...
                        try {
                            if ("true".equals(jsonObject.getString("status"))) {
                                ...
                                gridView.setAdapter(new kaicaliebiao_adapter(guess_hero.this, list_kaicai));
    ...
    private void init_guizhe() {
        right.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(guess_hero.this, guize_hero.class);
    ...
    private void init_jigncai_dingdan_click_meth() {
        jigncai_dingdan_click.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(guess_hero.this, hero_jingcaidingdan.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        jincai_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!MainActivity.IS_login) {
                    Intent intent = new Intent(guess_hero.this, user_login.class);
                    startActivity(intent);
                    finish();
                }
                ...
                try {
                    ...
                    if (!ok_panduan) {
                        ...
                        Toast.makeText(guess_hero.this, "您未下注，请点击下注", Toast.LENGTH_SHORT).show();
                        return;
                    }
                ...
                AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
                asyncHttpClient.setTimeout(20000);
                String url = all_url.url_before_order_lol;
                RequestParams requestParams = new RequestParams();
                ...
                asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(JSONObject jsonObject) {
                        ...
                        try {
                            if ("true".equals(jsonObject.getString("status"))) {
                                ...
                                AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
                                asyncHttpClient.setTimeout(20000);
                                String url = all_url.url_order2_lol;
                                RequestParams requestParams = new RequestParams();
                                requestParams.put("DATA", object.toString());
                                    ...
                                    public void onSuccess(JSONObject jsonObject) {
                                        ...
                                        try {
                                            if ("true".equals(jsonObject.getString("status"))) {
                                                ...
                                                lol_pay_list_adapter lol_pay_list_adapter=new lol_pay_list_adapter(guess_hero.this,list_objects);
                                                        ...
                                                        asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
                                                            ...
                                                            public void onSuccess(JSONObject jsonObject) {
                                                                ...
                                                                try {
                                                                    if ("true".equals(jsonObject.getString("status"))) {
                                                                        finish();
                                                                        Intent intent=new Intent(guess_hero.this,guess_hero.class);
                                                                        startActivity(intent);
                                                                        Toast.makeText(guess_hero.this, jsonObject.getString("result"), Toast.LENGTH_SHORT).show();
                                                                        jincai_ok.setEnabled(true);
                                                                    } else {
                                                            ...
                                                            public void onFailure(Throwable throwable) {
                                                                super.onFailure(throwable);
                                                                Toast.makeText(guess_hero.this, "网络繁忙，求重试", Toast.LENGTH_SHORT).show();
                                                            }
                    ...
                    public void onFailure(Throwable throwable) {
                        super.onFailure(throwable);
                        please_wait.setVisibility(View.GONE);
                        Toast.makeText(guess_hero.this, "网络繁忙，请重试", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
...
//弹出筛子的框
    private void sezi(final int ii, int[] a){
        ...
        builder = new AlertDialog.Builder(guess_hero.this);
        alert = builder.create();
        view=LayoutInflater.from(guess_hero.this).inflate(R.layout.sezi_four,null);
...
//                                hm.setHMLX(hm_list.getJSONObject(i).getString("HMLX"));
    ...
    private void draw_hero() {
        list_view_hero_holder=new ArrayList<>();
        list_view_hero=new ArrayList<>();
        for (int i=0;i<list_hero.size();i++){
            if(i<7&&i>=0){
                RelativeLayout re = new RelativeLayout(this);//一个item

                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(whith_rct_7, whith_rct_7);
                lp.setMargins(10, 10, 10, 10);
                re.setLayoutParams(lp);
                ImageView imageView=new ImageView(this);
                imageView.setLayoutParams(lp);
                re.addView(imageView);
                ImageView imageView_holder=new ImageView(this);
                imageView_holder.setLayoutParams(lp);
                re.addView(imageView_holder);
                list_view_hero_holder.add(imageView_holder);
//                imageView_holder.setBackgroundColor(getResources().getColor(R.color.touming2));
                ImageLoader.getInstance().displayImage(list_hero.get(i).getUrl().trim(),imageView);
//                re.setBackgroundResource(R.mipmap.ic_launcher);
                TextView flog=new TextView(guess_hero.this);
                flog.setTextSize(10);
                flog.setTextColor(getResources().getColor(R.color.black));
                flog.setBackgroundColor(getResources().getColor(R.color.white));
                if(Integer.parseInt(list_hero.get(i).getNumber())<10){
                    flog.setText("0"+list_hero.get(i).getNumber());
                }

                RelativeLayout.LayoutParams lp1 = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                lp1.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, RelativeLayout.TRUE);
                re.addView(flog,lp1);
                xiajiemia_last3.addView(re);
                list_view_hero.add(re);
            }
            if(i<14&&i>=7){
                RelativeLayout re = new RelativeLayout(this);//一个item
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(whith_rct_7, whith_rct_7);
                ...
                if(Integer.parseInt(list_hero.get(i).getNumber())<10){
                    ...
                    flog.setText(list_hero.get(i).getNumber());
                }
                RelativeLayout.LayoutParams lp1 = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                lp1.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, RelativeLayout.TRUE);
                re.addView(flog,lp1);
                xiajiemia_last2.addView(re);
                list_view_hero.add(re);
            }
            if(i<21&&i>=14){
                RelativeLayout re = new RelativeLayout(this);//一个item
                ...
                lp1.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, RelativeLayout.TRUE);
                re.addView(flog,lp1);
                xiajiemia_last1.addView(re);
                list_view_hero.add(re);
            }
        }
        for (int i=0;i< list_view_hero.size();i++){
            final int a=i;
            list_view_hero.get(i).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    final AlertDialog alert;
                    AlertDialog.Builder builder;
    ...
    private void init_jbd(String my_qs, String next_qs) {
        ...
        more_qs_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(guess_hero.this, more_qs_hero.class);
                startActivity(intent);
                finish();
            ...
            list_12.get(i).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    ...
                    if ((zi_sy[0] > Integer.parseInt(list_Hm.get(a).getSY()))) {
                        Toast.makeText(guess_hero.this, "单注上限"+moer_50+"万", Toast.LENGTH_SHORT).show();
                    } else {
  /*
                    这个网络用来解释可不可以下
                     */
                        AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
                        asyncHttpClient.setTimeout(20000);
                        String url = all_url.url_lol_xiahzuxianzhu;
                        RequestParams requestParams = new RequestParams();
...
//        location2[1]=location2[1]+whith_rct/2;
        ...
        Animation fliiinf = new TranslateAnimation(location[0], location2[0], location[1] - DensityUtil.dip2px(guess_hero.this, 115), location2[1] - DensityUtil.dip2px(guess_hero.this, 100));
...
//                    guess_but_down.setImageResource(R.mipmap.all_guess_xiala);
    ...
    private Handler lhandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.arg2 == 2) {//停止下注
                Toast.makeText(guess_hero.this, next_expect + "停止下注", Toast.LENGTH_SHORT).show();
            }
...
//            e.printStackTrace();
//        }
        jincai_group_num.setText(list_kaijiang_results.get(0).getCode_all());
        list_qs_view.clear();

        all_guess_open_number.removeAllViews();
        for (int i = 0; i < list_kaijiang_results.size(); i++) {
            View qs_view = mInflater.inflate(R.layout.guess_qspk_xiangp, null);
            TextView qs= (TextView) qs_view.findViewById(R.id.jincai_line1_1);
            TextView op_number= (TextView) qs_view.findViewById(R.id.jincai_line1_2);
            TextView hezhi= (TextView) qs_view.findViewById(R.id.jincai_line1_3);
            TextView jieguo= (TextView) qs_view.findViewById(R.id.jincai_line1_4);
            qs.setText(list_kaijiang_results.get(i).getExpect());
            op_number.setText(list_kaijiang_results.get(i).getCode_1()+"+"+list_kaijiang_results.get(i).getCode_2()+"+"+list_kaijiang_results.get(i).getCode_3()+"+"+list_kaijiang_results.get(i).getCode_4());
            hezhi.setText(list_kaijiang_results.get(i).getCode_all());
            jieguo.setText(list_kaijiang_results.get(i).getResult());
            all_guess_open_number.addView(qs_view);
            list_qs_view.add(qs_view);
        }
        View more_qs_view = mInflater.inflate(R.layout.item_more_kaijiang_qishu, null);
    ...
    public void onBackPressed() {
        biaoshi_hero=false;
        Intent intent = new Intent(guess_hero.this, MainActivity.class);
        startActivity(intent);
        onDestroy();
    }
...
//                System.out.println(time_text_f+","+time_text_s);
    ...
    private void init() {
        ...
        whith_rct = (MainActivity.screenWidth - 5 * DensityUtil.dip2px(guess_hero.this, 30)) / 4;
        whith_rct_3 = (MainActivity.screenWidth - 4 * DensityUtil.dip2px(guess_hero.this, 30)) / 3;
        whith_rct_7 = (MainActivity.screenWidth - 6 * DensityUtil.dip2px(guess_hero.this, 30)) / 5;
        ...
        xiajiemia_last1 = (LinearLayout) findViewById(R.id.xiajiemia_last1);
        xiajiemia_last2 = (LinearLayout) findViewById(R.id.xiajiemia_last2);
        xiajiemia_last3 = (LinearLayout) findViewById(R.id.xiajiemia_last3);
        ...
        Typeface type = Typeface.createFromAsset(guess_hero.this.getAssets(), "yjsz.ttf");
