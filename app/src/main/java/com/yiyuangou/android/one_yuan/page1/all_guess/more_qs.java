 ...
 */
public class more_qs extends Activity {
            ...
            public void onSuccess(int arg0, JSONObject arg1) {
                ...
                try {
                    if ("true".equals(arg1.getString("status"))) {
                        ...
                        adapter = new guess_more_hm_adapter(more_qs.this, list_open_qs,list_kaijiang_results);
    ...
    public void onBackPressed() {
        ...
        finish();
        Intent intent=new Intent(more_qs.this,guess.class);
