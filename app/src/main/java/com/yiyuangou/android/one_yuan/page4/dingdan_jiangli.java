 ...
 */
public class dingdan_jiangli extends Fragment {
    private View view;
    GridView gridView;
    dingdan_jiangli_adapter adapter;
    PullToRefreshLayout.OnRefreshListener re;
    private View xiangyaotoum;
    private View zhanwushuju;
    int flag=1;
    List<item_jiangli> list ;
    @Nullable
    @Override
   ...
   /*
    ...
    private void init() {
        ...
        list=new ArrayList<item_jiangli>();
    }
    ...
    protected void init_wangluo_init() {
        ...
        String url = all_url.url_jiangli;//-----------jaingli
            ...
            public void onSuccess(int arg0, JSONObject arg1) {
                ...
                try {
                    if("true".equals(arg1.getString("status"))){
                        ...
                        JSONArray jsonArray;
                        jsonArray = arg1.getJSONArray("rewardLog");
                        list.clear();
                        for (int i = 0; i < jsonArray.length(); i++) {
                           item_jiangli item=new item_jiangli();
                            item.setMoney(jsonArray.getJSONObject(i).getString("jd"));
				 ...
				 * 适配器和布局在这里初始化好
				 */
                        adapter=new dingdan_jiangli_adapter(getActivity(), list);
