...
import com.yiyuangou.android.one_yuan.page1.guess_hero2.hero_dingdan_xiangq2;
 ...
 */
public class dingdan_hero_adapter extends BaseAdapter {
    ...
    public dingdan_hero_adapter(Context context, List<jingcai_item> lists){
        this. lists=lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        view= (LinearLayout) LayoutInflater.from(context).inflate(R.layout.hero_dingdan_da_item, null);
        ...
        quanbu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, hero_dingdan_xiangq2.class);
