 ...
 */
public class hero_jingcaidingdan extends FragmentActivity {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                if (currentIndex == 0 && position == 0)// 0->1
                {
                    ...
                    LinearLayout.LayoutParams lp = (android.widget.LinearLayout.LayoutParams) dingdan_imgtap
                            .getLayoutParams();
    ...
    private void init() {
        ...
        dingdan_hero_click dingdan_hero_click=new dingdan_hero_click();
        dingdan_kaicai_click dingdan_kaicai_click=new dingdan_kaicai_click();
    ...
    public void onBackPressed() {
        Intent intent=new Intent(hero_jingcaidingdan.this,guess_hero.class);
