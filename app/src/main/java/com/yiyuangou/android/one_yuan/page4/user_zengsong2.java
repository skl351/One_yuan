 ...
 */
public class user_zengsong2 extends Fragment {
    private View view;
    private dingdan_zengdong_adapter adapter;
    GridView gridView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.user_zengsong2, container, false);
        init();
        init_wangluo_init();
          /*
    ...
    protected void init_wangluo_init() {
        ...
        requestParams.put("ZSYHID", User.getuser().getUser_uuid());
        ...
        asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int arg0, JSONObject arg1) {
                ...
                try {
                    if ("true".equals(arg1.getString("status"))) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String other_phone = jsonArray.getJSONObject(i).getString("phone");
                            String user_name = jsonArray.getJSONObject(i).getString("userName");
				 ...
				 * 适配器和布局在这里初始化好
				 */
                        adapter = new dingdan_zengdong_adapter(getActivity(), list);
