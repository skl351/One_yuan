 ...
 */
public class guess_open3 extends Activity {
    ...
    private void init_kaijiangshuoming() {
        ...
        asyncHttpClient.post(url,new JsonHttpResponseHandler() {
            ...
            public void onSuccess(JSONObject jsonObject) {
                ...
                try {
                    if ("true".equals(jsonObject.getString("status"))) {
                        ...
                        Toast.makeText(guess_open3.this, jsonObject.getString("result"), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onFailure(Throwable throwable) {
                ...
                Toast.makeText(guess_open3.this, "网络繁忙，请重试", Toast.LENGTH_SHORT).show();
            }
        });
    }
