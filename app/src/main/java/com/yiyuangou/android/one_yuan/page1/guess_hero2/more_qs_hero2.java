 ...
 */
public class more_qs_hero2 extends Activity {
    ...
    protected void init_wangluo_init() {
        ...
        String url = all_url.url_open_more_lol2;
            ...
            public void onSuccess(int arg0, JSONObject arg1) {
                ...
                try {
                    if ("true".equals(arg1.getString("status"))) {
                        ...
                        adapter = new guess_more_hm_adapter_hero(more_qs_hero2.this,list_kaijiang_results);
    ...
    public void onBackPressed() {
        finish();
        Intent intent=new Intent(more_qs_hero2.this,guess_hero2.class);
