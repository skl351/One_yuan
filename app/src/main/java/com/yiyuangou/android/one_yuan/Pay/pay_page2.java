 ...
 */
public class pay_page2 extends Activity {
    ...
    public void onBackPressed() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(pay_page2.this);
        builder.setTitle("你确定取消支付吗");
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent=new Intent(pay_page2.this,MainActivity.class);
...
//                        myself_keyong_je.setText(jsonObject.getJSONObject("user").getString("balance"));//金额
                        ...
                        Toast.makeText(pay_page2.this, jsonObject.getString("result"), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onFailure(Throwable throwable) {
                ...
                Toast.makeText(pay_page2.this, "网络繁忙，请重试", Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            public void onClick(View v) {
                ...
                asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(JSONObject jsonObject) {
                        ...
                        try {
                            if ("true".equals(jsonObject.getString("status"))) {
                                Intent intent=new Intent(pay_page2.this,pk_ten.class);
                                startActivity(intent);
                    ...
                    public void onFailure(Throwable throwable) {
                        super.onFailure(throwable);
                        Toast.makeText(pay_page2.this, "网络繁忙，求重试", Toast.LENGTH_SHORT).show();
                    }
