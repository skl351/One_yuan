 ...
 */
public class jingcai_dingdan_xiangq extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestWindowFeature(Window.FEATURE_NO_TITLE);setContentView(R.layout.jigncai_dingdan_xiangq);
    ...
    protected void init_wangluo() {
        ...
        String url = all_url.url_orderinfo;
                ...
                try {
                    if("true".equals(arg1.getString("status"))){
                        ...
                        for (int i=0;i<jsonArray.length();i++){
                            ...
                            xunijigncai_xiangq_group1.setText(jsonArray.getJSONObject(i).getString("group_1"));
                            xunijigncai_xiangq_group2.setText(jsonArray.getJSONObject(i).getString("group_2"));
                            xunijigncai_xiangq_group3.setText(jsonArray.getJSONObject(i).getString("group_3"));
                            xunijigncai_xiangq_groupnum.setText(jsonArray.getJSONObject(i).getString("group_num"));
