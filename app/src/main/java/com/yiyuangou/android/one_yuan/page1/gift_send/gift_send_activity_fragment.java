 ...
 */
public class gift_send_activity_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        flag="skl_quan";
        view=inflater.inflate(R.layout.click_gift_activity, container, false);
        init();
        init_wangluo();
        init_back();
            ...
            public void onSuccess(JSONObject jsonObject) {
                ...
                try {
                    if ("true".equals(jsonObject.getString("status"))){
                        ...
                        Button button_quanbu= new Button(getActivity());
                        ...
                        lp1.height= DensityUtil.dip2px(getActivity(),44);
                        if(js.length()>=3){
                        ...
                        for (int i=0;i<js.length();i++){//根据分类的数量，来添加按钮
                            ...
                            lp2.height= DensityUtil.dip2px(getActivity(),44);
                            if(js.length()>=3){
...
//                btn_cls.bt_endisable(login_submit);
    ...
    private void init() {
        fenlei_line= (LinearLayout) view.findViewById(R.id.fenlei_line);
        gift_topbar=view.findViewById(R.id.gift_topbar);
