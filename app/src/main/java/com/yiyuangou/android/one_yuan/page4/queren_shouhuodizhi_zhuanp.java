 ...
 */
public class queren_shouhuodizhi_zhuanp extends Activity {
    ...
    private void init_add() {
        add_adress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(queren_shouhuodizhi_zhuanp.this,user_shouhuo.class);
    ...
    private void init_wangluo() {
        ...
        asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
                ...
                try {
                    if ("true".equals(jsonObject.getString("status"))) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            View view = LayoutInflater.from(queren_shouhuodizhi_zhuanp.this).inflate(R.layout.item_querenshouhuo_item, null);
                        ...
                        Toast.makeText(queren_shouhuodizhi_zhuanp.this, jsonObject.getString("result"), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onFailure(Throwable throwable) {
                ...
                Toast.makeText(queren_shouhuodizhi_zhuanp.this, "网络繁忙，请重试", Toast.LENGTH_SHORT).show();
    ...
    private void init_ok() {
        lijiduihuan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (id == "") {
                    Toast.makeText(queren_shouhuodizhi_zhuanp.this, "请确认地址", Toast.LENGTH_SHORT).show();
                    return;
                }


                final AlertDialog.Builder builder = new AlertDialog.Builder(queren_shouhuodizhi_zhuanp.this);
//                builder.setIcon(R.mipmap.ic_launcher);//设置图标
//                builder.setTitle("标题");
                View view = LayoutInflater.from(queren_shouhuodizhi_zhuanp.this).inflate(R.layout.gift_beizhu, null);
                ...
                but_ok.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        submit(beizhu.getText().toString());
                        alert.dismiss();
    ...
    private void submit(String beizhu) {
        String id = "";
        for (int i = 0; i < list_id.size(); i++) {
            if (list_panduan.get(i)) {
                id = list_id.get(i);
        ...
        AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
        String url = all_url.url_get_thing;
        RequestParams requestParams = new RequestParams();
        requestParams.put("userId", User.getuser().getUser_uuid());
        requestParams.put("awardLogid", getIntent().getStringExtra("uuid"));
        requestParams.put("id", id);
        requestParams.put("message", beizhu);
        asyncHttpClient.setTimeout(20000);
        System.out.println(User.getuser().getUser_uuid()+">"+getIntent().getStringExtra("uuid")+"<"+id);
        asyncHttpClient.post(url, requestParams, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(JSONObject jsonObject) {
                super.onSuccess(jsonObject);
            System.out.println(jsonObject);
                try {
                    if ("true".equals(jsonObject.getString("status"))) {
                        Toast.makeText(queren_shouhuodizhi_zhuanp.this, jsonObject.getString("result"), Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(queren_shouhuodizhi_zhuanp.this, MainActivity.class);
                        startActivity(intent);
                    } else {
                        Toast.makeText(queren_shouhuodizhi_zhuanp.this, jsonObject.getString("result"), Toast.LENGTH_SHORT).show();
                    }
...
//                builder.setIcon(R.mipmap.ic_launcher);//设置图标
//                builder.setTitle("标题");
        View view= LayoutInflater.from(queren_shouhuodizhi_zhuanp.this).inflate(R.layout.gift_tanchuang, null);
        View but_ok= view.findViewById(R.id.zengs_dialo_zhongjian_ok);
