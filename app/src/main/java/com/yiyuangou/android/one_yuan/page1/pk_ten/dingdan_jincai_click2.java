...
import com.yiyuangou.android.one_yuan.adapter.dingdan_jingcai_adapter2;
 ...
 */
public class dingdan_jincai_click2 extends Fragment {
    private View view;
    dingdan_jingcai_adapter2 adapter ;
    GridView gridView;
    ...
    protected void init_wangluo_init() {
        ...
        String url = all_url.url_jincaidingdan_pk;
        ...
        asyncHttpClient.post(url,requestParams,new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int arg0, JSONObject arg1) {
				 ...
				 * 适配器和布局在这里初始化好
				 */
                       adapter=new dingdan_jingcai_adapter2(getActivity(), qs_s);
